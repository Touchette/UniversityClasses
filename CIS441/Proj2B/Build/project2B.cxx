  ...
  public:
   ...
   void Black(void) { glColor3ub(0, 0, 0); };
	...
	virtual void RenderPiece(vtkRenderer *ren, vtkActor *act) {
		...
		glPushMatrix();
		glRotatef(-55, 0, 1, 0);
		glScalef(0.35, 0.35, 7);
		glTranslatef(-40, 0, 1.6);
		DrawCylinder();
		glPopMatrix();
		...
		glPushMatrix();
		glScalef(.75, .75, 5);
		glTranslatef(-5, 2, -2.35); // first leg
		DrawCylinder();
		LightBrown();
		glTranslatef(0, -4, 0); // second leg
		DrawCylinder();
		LightBrown();
		glTranslatef(-17, 4, 0); // third leg
		DrawCylinder();
		Brown();
		glTranslatef(0, -4, 0); // fourth leg
		DrawCylinder();
		glPopMatrix();

		// draw the feet
		LightBrown();
		glPushMatrix(); // first foot
		glScalef(2, 1, 0.25);
		glTranslatef(-1.33, 1.5, -47.35);
		DrawCylinder();
		DarkBrown();
		glTranslatef(0, -3, 0); // second foot
		DrawCylinder();
		glTranslatef(-6.4, 3, 0); // third foot
		DrawCylinder();
		LightBrown();
		glTranslatef(0, -3, 0); // fourth foot
		DrawCylinder();
		glPopMatrix();
		...
		LightBrown();
		glPushMatrix();
		glScalef(1.75, 1.75, 0.5);
		glTranslatef(2, 0, -1.75);
		DrawSphere();
